...
def draw_punk(eye_color, dress_color, x_coordinate):
    ...
    circle(screen, dress_color,(int(punk_pos[0]),500),140)
    ...
    shoulder((punk_pos[0] + 110,390), 40, -0.2, dress_color)
    shoulder((punk_pos[0] - 110,390), 40, -0.2, dress_color)
    draw_head(100,punk_pos, eye_color)
#    hair(10,punk_pos,(23,150,90),100)


draw_punk((0,255,255),(255,0,0),300)
draw_punk((0,0,255),(105,140,170),800)

polygon(screen,(0,255,0),((0,0),(1100,0),(1100,100),(0,100)))
